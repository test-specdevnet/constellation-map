...
- The debug HUD shows FPS, frame time, sim tick rate, entity counts, input axes, and current player state.

## Runtime feature flags

These can be changed at runtime in `Controls / Settings`, and default from environment variables:

- `NEXT_PUBLIC_FC_FLAG_COMBAT`
